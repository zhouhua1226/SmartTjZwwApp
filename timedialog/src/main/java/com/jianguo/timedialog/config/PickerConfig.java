package com.jianguo.timedialog.config;


import com.jianguo.timedialog.data.Type;
import com.jianguo.timedialog.data.WheelCalendar;
...
public class PickerConfig {
    ...
    public String mProvice = DefaultConfig.PROVICE;
    public String mCity = DefaultConfig.CITY;
    public String mCounty = DefaultConfig.COUNTY;
    ...
    public OnAddressSetListener mAddressBack;
}
