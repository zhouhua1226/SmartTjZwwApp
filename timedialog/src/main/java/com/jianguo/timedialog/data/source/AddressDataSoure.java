package com.jianguo.timedialog.data.source;

import android.content.Context;

import com.jianguo.timedialog.R;
import com.jianguo.timedialog.data.CityModel;
import com.jianguo.timedialog.data.DistrictModel;
import com.jianguo.timedialog.data.ProvinceModel;
import com.jianguo.timedialog.data.service.XmlParserHandler;
...
public class AddressDataSoure {
     ...
     * 解析省市区的XML数据
     */
    public  AddressDataSoure(Context  mContext){
        List<ProvinceModel> provinceList = null;
        try {
            InputStream input  = mContext.getResources().openRawResource( R.raw.province_data);
            // 创建一个解析xml的工厂对象
