...
public class UrlUtils {
    ...
    public static final String URL = "http://111.231.139.61:18081"; // http://47.100.15.18:8080
    ...
    //娃娃图url
    public static final String PICTUREURL = URL + "/pooh-web/app/uploadFiles/DollImage/";

    //充值卡url
    public static final String PAYCARDTPURL = URL + "/pooh-web/app/uploadFiles/paycard/";
    //退出登录
    public static final String LOGOUT=URL+"/pooh-web/app/logout";

    //头像上传http://47.100.15.18:8080/pooh-web/api/updateUser
    public static final String FACEIMAGEURL = URL + "/pooh-web/app/api/updateUser";

    //修改昵称
    public static final String UserNickNameURL = URL + "/faceImage";

    //修改用户名  11/21 13：10
    public static final String USERNAMEURL = URL + "/pooh-web/app/api/updateUserName";
    ...
    //充值接口
    public static final String USERPAYURL = URL + "/pooh-web/app/pay/balance";

    //消费接口
    public static final String USERPLAYURL = URL + "/pooh-web/app/pay/costBalance";

    //listRank
    public static final String LISTRANKURL = URL + "/pooh-web/app/rank/rankList";

    //视屏上传upload
    public static final String UPLOADURL = URL + "/pooh-web/app/play/regPlayBack";

    //获取视频回放列表
    public static final String VIDEOBACKURL = URL + "/pooh-web/app/play/getPlayRecord";

    //获取房间用户头像
    public static final String CTRLUSERIMAGE = URL + "/pooh-web/app/api/getUser";

    //跑马灯l
    public static final String getUserList = URL + "/pooh-web/app/play/getUserList";
    ...
    //开始游戏分发场次
    public static final String CREATPLAYLISTURL = URL + "/pooh-web/app/pay/creatPlayList";
    ...
    //获取用户信息接口
    public static final String GETUSERDATEURL=URL+"/pooh-web/app/api/getUserInfo";    //参数：userId 获取用户信息
