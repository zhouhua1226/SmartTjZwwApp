    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_ok:
                ...
                wxPayMoney(UserUtils.USER_ID, moneyzf);
                break;
...
//                getPlayNum(UserUtils.UserPhone, moneyzf);
    ...
    private void wxPayMoney(String userId, String money) {
        //String phones = Base64.encodeToString(phone.getBytes(), Base64.DEFAULT);
        HttpManager.getInstance().getUserPay(userId, money, new RequestSubscriber<Result<LoginInfo>>() {
            @Override
